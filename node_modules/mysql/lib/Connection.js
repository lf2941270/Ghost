...
Connection.prototype.connect = function(cb) {
  if (!this._connectCalled) {
    ...
    // Modify: remove protocol all listeners
    ...
    // Modify: reconnect if socket on 'close' event
    var self = this;
    this._socket.on('close', function () {
      //console.log('socket on close');
      self._connectCalled = false;
      self._protocol._destroyed = false;
      self._protocol._handshakeSequence = null;
      self._protocol.resume();
